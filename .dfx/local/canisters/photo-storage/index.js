...
import { idlFactory } from './photo-storage.did.js';
export { idlFactory } from './photo-storage.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PHOTO_STORAGE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./photo-storage.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the photo-storage canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./photo-storage.did.js")._SERVICE>}
 */
export const photo_storage = createActor(canisterId);
